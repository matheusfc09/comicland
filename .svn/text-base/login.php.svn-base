				...
				<div class="span9">
					<section>
						...
						<div class="content">
							...
							<form class="form-horizontal" action="authenticate_user.php" method="POST">
								<input type="hidden" name="token" value="<?php echo $_SESSION['token'];?>">
								<div class="control-group">
									<label class="control-label">Username</label>
									<div class="controls">
										<input type="text" name="user[username]" placeholder="Enter your username">
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									<div class="controls">
										...
										<div style="margin-top: 20px">Not a user yet? <a href="<?php echo ROOT_PATH."signup.php" ?>">Sign Up</a></div>
									</div>
								</div>
							</form>
						</div>
